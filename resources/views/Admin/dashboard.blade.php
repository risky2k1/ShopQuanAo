                            ...
                            <div class="table-responsive table-sales">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flag">
                                                <img src={{asset('admin/img/flags/DE.png')}}>
                                            </div>
                                        </td>
                                        <td>Germany</td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flag">
                                                <img src={{asset('admin/img/flags/GB.png')}}>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flag">
                                                <img src={{asset('admin/img/flags/RO.png')}}>
                                            </div>
                                        </td>
                                        <td>Romania</td>
                                        <td class="text-right">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-product">
                <div class="card-image" data-header-animation="true">
                    <a href="#pablo">
                        <img class="img" src={{asset('admin/img/card-2.jpeg')}}>
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-actions">
        ...
        <div class="col-md-4">
            <div class="card card-product">
                <div class="card-image" data-header-animation="true">
                    <a href="#pablo">
                        <img class="img" src={{asset('admin/img/card-3.jpeg')}}>
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-actions">
        ...
        <div class="col-md-4">
            <div class="card card-product">
                <div class="card-image" data-header-animation="true">
                    <a href="#pablo">
                        <img class="img" src={{asset('admin/img/card-1.jpeg')}}>
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-actions">
